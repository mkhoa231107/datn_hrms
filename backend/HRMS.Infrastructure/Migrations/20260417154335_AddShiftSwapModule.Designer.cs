...
namespace HRMS.Infrastructure.Migrations
{
    ...
    [Migration("20260417154335_AddShiftSwapModule")]
    partial class AddShiftSwapModule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HRMS.Domain.Entities.ShiftSwapRequest", b =>
                {
                    ...
                    b.HasOne("HRMS.Domain.Entities.WorkShift", "ShiftA")
                        .WithMany()
                        .HasForeignKey("ShiftAId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HRMS.Domain.Entities.WorkShift", "ShiftB")
                        .WithMany()
                        .HasForeignKey("ShiftBId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
